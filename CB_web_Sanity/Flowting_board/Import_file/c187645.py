...
time.sleep(1)
driver1.find_element(By.CSS_SELECTOR,'#white-board > div > div:nth-child(6) > div:nth-child(2) > div:nth-child(5)').click()
time.sleep(1)
...
# 比較圖片,回傳相似結果
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Import_file\\import-file_pdf-full screen-compare.png"
...
# 點擊"垃圾桶" , 清空session
driver1.find_element(By.CSS_SELECTOR,'body > div:nth-child(3) > div:nth-child(1) > img').click()
time.sleep(1)
