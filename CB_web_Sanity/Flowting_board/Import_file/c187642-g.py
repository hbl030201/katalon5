...
# 匯入png圖片
driver1.find_element(By.XPATH,'/html/body/div/div[9]/div/section/div[2]/ul/li[3]').click()
time.sleep(2)
...
# 比較圖片,回傳相似結果
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Import_file\\import-file-g_png-compare.png"
