...
# 點擊floatingBoard>Import>google drive
driver1.find_element(By.CSS_SELECTOR,'#floatingBoard-switch').click()
time.sleep(1)
driver1.find_element(By.CSS_SELECTOR,'#floatingBoard-import').click()
time.sleep(1)
driver1.find_element(By.CSS_SELECTOR,'#root > div:nth-child(5) > div > div > div > div.floatingFileMenu > ul > li:nth-child(2)').click()
time.sleep(2)

# 匯入pdf圖片
driver1.find_element(By.XPATH,'/html/body/div/div[9]/div/section/div[2]/ul/li[2]').click()
time.sleep(2)
driver1.find_element(By.XPATH,'/html/body/div/div[9]/div/section/div[3]/ul/li[2]').click()
time.sleep(10)
...
# 比較圖片,回傳相似結果
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Import_file\\import-file-g_pdf-compare.png"
