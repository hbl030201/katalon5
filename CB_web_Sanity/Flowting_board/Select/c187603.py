...
pyautogui.write('C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Select\\photos\\shiba.jpg')
...
time.sleep(1)
driver1.find_element(By.CSS_SELECTOR,'#white-board > div > div > div:nth-child(2) > div:nth-child(3)').click()
time.sleep(1)
...
# 比較圖片,回傳相似結果
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Select\\jpg-delete-compare.png"
