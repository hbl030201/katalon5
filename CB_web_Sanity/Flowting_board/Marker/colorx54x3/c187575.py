...
for i in range(1,4,1):
 ...
 # 比較圖片,回傳相似結果
 fb = "C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Marker\\colorx54x3\\fb.png"
...
for i in range(1,55,1):
 ...
 driver1.find_element(By.CSS_SELECTOR,'#root > div:nth-child(5) > div > div.palette > div > ul > li:nth-child(2) > a > span').click()

 # 點擊"color"
 driver1.find_element(By.CSS_SELECTOR,'#root > div:nth-child(5) > div > div.palette > div > ul > li:nth-child(2) > a').click()
 address = '#root > div:nth-child(5) > div > div.palette > div > section > div.colorThemeCycle_contentInner._color.active > ul:nth-child(1) > li:nth-child(%s) > a'% (i)
 ...
 file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Marker\\colorx54x3\\"+ compare_image
