...
driver1.find_element(By.CSS_SELECTOR,'#root > div:nth-child(5) > div > div.floatingBoard._floatingTool.adder > div > div.floatingBoard-2st-wrap > ul > li.floatingBoard-2st-li._colorCycle._cycle9 > a').click()

for i in range(1, 18, 1):
 driver1.find_element(By.CSS_SELECTOR,'#root > div:nth-child(5) > div > div.pen-thickness > div > div.thickness > div > a.iconBtn-icOnly._zoomIn').click() 
 time.sleep(1)
...
#  print("file1 = "+file1)
 ...
 # 比較圖片,回傳相似結果
 compare_image = 'thickness' + str(i) + '_compare.png'
 file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Pen\\pen_Thickness\\"+ compare_image
