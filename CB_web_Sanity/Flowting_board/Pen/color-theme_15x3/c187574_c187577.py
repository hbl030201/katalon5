...
for i in range(1,4,1):
 ...
 time.sleep(1)
 # 比較圖片,回傳相似結果
 fb = "C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Pen\\color-theme_15x3\\fb.png"
...
for j in range(1,4,1):
 ...
 for i in range(2,9,1):
  ...
  file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Flowting_board\\Pen\\color-theme_15x3\\"+ compare_image
