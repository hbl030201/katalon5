...
# 點擊"Sticker" icon
 ...
 # 點"3D"tab
 driver1.find_element(By.CSS_SELECTOR,'#root > div:nth-child(5) > div > div.sticker-menu > div > ul > li:nth-child(2) > a').click()
 time.sleep(1)
...
#   print("file1 = "+file1)
  ...
  # 比對圖片
  compare_image = '3D' + str(i)  + '_' + str(j) + '_compare.png'
