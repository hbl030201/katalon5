...
# double click % 數
driver1.find_element(By.CSS_SELECTOR,'#root > div.footerTool > section.footerTool_zoom.footerTool_wrap > ul > li:nth-child(2) > div').click()          
driver1.find_element(By.CSS_SELECTOR,'#root > div.footerTool > section.footerTool_zoom.footerTool_wrap > ul > li:nth-child(2) > div').click()          
time.sleep(1)  
...
#  比對圖片
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Footer\\re_100p\\100p_compare.png"
