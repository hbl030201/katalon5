...
# 點開 preview window
driver1.find_element(By.CSS_SELECTOR,'#root > div.footerTool > section.footerTool_zoom.footerTool_wrap > ul > li:nth-child(4) > a').click()          
time.sleep(1)  

# 拖拉 preview window
startx1=size['width']*1.2
starty1=size['height']*1.2
endx2=size['width']*1.3
endy2=size['height']*1.2
pyautogui.moveTo(startx1, starty1)
pyautogui.dragTo(endx2, endy2, 1, button='left')
time.sleep(1)
...
#  比對圖片
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Footer\\preview window\\preview 1_compare.png"
...
# 拖拉 preview window
startx1=size['width']*1.3
starty1=size['height']*1.2
endx2=size['width']*1.1
endy2=size['height']*1.2
pyautogui.moveTo(startx1, starty1)
pyautogui.dragTo(endx2, endy2, 1, button='left')
time.sleep(1)
...
#  比對圖片
file2="C:\\Users\\yuki.lin\\CB_web_Sanity\\Footer\\preview window\\preview 2_compare.png"
